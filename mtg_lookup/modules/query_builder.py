...
class QueryBuilder:
    ...
    def reset_vars():
        QueryBuilder.qry = "SELECT * FROM CARDS WHERE "
        #QueryBuilder.cursor = None
        QueryBuilder.cursor_results = None
        QueryBuilder.this_criteria = set()
        #criteria_groups = set()
        QueryBuilder.criteria_groups = []
        QueryBuilder.print_setting = ""
        QueryBuilder.custom_print_str = ""
        QueryBuilder.bool_operation = None
        QueryBuilder.debug_options = {"PRINT_QUERY":False}
        QueryBuilder.sort_cols = []
        QueryBuilder.randoms_to_get = 0
        QueryBuilder.els_chosen = []
